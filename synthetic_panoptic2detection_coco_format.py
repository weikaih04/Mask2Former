...
if __name__ == "__main__":
    ...
    # input_json_file = os.path.join(root, "annotations", "panoptic_val.json")
    # output_json_file = os.path.join(root, "annotations", "panoptic2instances_val.json")
    # categories_json_file = "datasets/synthetic_categories.json"
    # segmentations_folder = os.path.join(root, "panoptic_val")
